<div class="columns is-multiline">
    ...
    <div class="column is-full">
        <div class="card">
            ...
            <div class="card-content">
                <div class="columns">
                    <!-- Funcionalidad del Asistente DateIO (Izquierda) -->
                    <div class="column is-half">
                        ...
                        <div class="content" style="clear: both;">
                            ...
                            if (isset($_REQUEST['message'])) {
                                ...
                                echo '<div class="notification is-info" style="clear: both;"><strong>Assistant:</strong> Soy DateIO, ¿qué necesitas hoy?</div>';
                            }
                            ?>
                        </div>
                    </div>
